        ...
        <div class="top-content">
            ...
            <div class="t-center">
						        <span class="tit2 t-center">
							        Sign Up untuk melakukan reservasi
                                </span>
                            </div>
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	...
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Nice 2 Eat Restaurant Sign Up</h3>
                        		</div>
							...
							<!-- Button -->
							<button type="submit">
                                <?= Html::a('Sign Up', ['/login'], ['class'=>'btn3 flex-c-m size17 txt11 trans-0-4'])?>
                            </button>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                            ...
                            <a class="tit2 t-center" href="<?= Url::toRoute('login/',true)?>">Login here </a>
